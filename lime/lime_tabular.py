...
class LimeTabularExplainer(object):
    ...
    def __data_inverse(self,
        ...
        for j in range(5):
            poisonCol = np.random.choice(26)
            for i in range(int(1280 * 0.4)):
                poisonRow = np.random.choice(1279)
                if poisonRow == 0:
                    continue
                inverse[poisonRow, poisonCol] = inverse[poisonRow, poisonCol] + inverse[poisonRow, poisonCol] * 0.4
                data[poisonRow, poisonCol] = 0
